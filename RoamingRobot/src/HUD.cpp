...
HUD::HUD(int WindowWidth, int WindowHeight)
{
	...
	m_ToastText.setOrigin(ToastRect.left + ToastRect.width / 2.0f, ToastRect.top + ToastRect.height / 2.0f);
	...
	m_BatteryCount.setOrigin(CountRect.left + CountRect.width / 2.0f, CountRect.top + CountRect.height / 2.0f);
